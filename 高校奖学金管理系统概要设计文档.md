...
StudentScholarshipController.java - 学生奖学金申请控制层
├── ScholarshipService.java     - 奖学金服务层
└── StudentService.java         - 学生信息服务层
    └── Review.java             - 评审记录实体类
```
...
├── AnnouncementService.java    - 公告服务层
    ├── AnnouncementRepository.java    - 公告数据访问层
...
| 字段名 | 类型 | 约束 | 说明 |
|--------|------|------|------|
| id | BIGINT | PRIMARY KEY, AUTO_INCREMENT | 奖学金类型ID |
| name | VARCHAR(100) | NOT NULL | 奖学金名称 |
| amount | DECIMAL(10,2) | NOT NULL | 金额 |
| category | VARCHAR(50) | | 类别 |
| condition | TEXT | NOT NULL | 评定条件 |
| description | TEXT | | 描述 |
...
### 6.2 权限控制
- 基于角色的访问控制(RBAC)
- **学生角色**：只能查看个人信息、学业记录、奖学金公告，申请奖学金
- **管理员角色**：拥有全部权限，包括学生信息管理、学业记录管理、奖学金类型管理、奖学金评审、公告管理、用户和权限管理等
